...
public class Pagos {
    ...
    public static boolean tipoDePago(double montoAPagar) {
        ...
        while (opcion < 1 || opcion > 3) {
            ...
            System.out.println(
                    Colores.BRIGHT_VERDE +
                    "💰 MONTO A PAGAR: S/ " +
                    String.format("%.2f", montoAPagar)
                    + Colores.RESET
            );
            ...
            System.out.println(
                    Colores.BRIGHT_MORADO +
                    "2️⃣  Yape"
                    + Colores.RESET
            );

            System.out.println(
                    Colores.BRIGHT_AMARILLO +
                    "3️⃣  Efectivo"
                    + Colores.RESET
            );
    ...
    public static boolean procesarPagoConTarjeta(double montoAPagar) {
        ...
        while (tarjetaCliente == null) {
            ...
            try {
                ...
                tarjetaCliente = new Datos.Tarjeta(
                        num,
                        titular,
                        vencimiento,
                        cvv
    ...
    public static void imprimirBoleta(Datos.Boleta boleta) {
        ...
        System.out.println(
                Colores.BRIGHT_AZUL + Colores.NEGRITA +
                "===================================================="
                + Colores.RESET
        );

        System.out.println(
                Colores.NEGRITA + Colores.BRIGHT_BLANCO +
                "                 CRUZ DEL SUR"
                + Colores.RESET
        );
